...
if len(sys.argv)<2:
    ...
    with open(json_path, 'r', encoding='utf-8') as file:
        ...
        print(f"Autor comparision: (messages) ", autors_messages)
        print(f"Autor comparision: (characters) ", autors_characters)
        print(f"Autor comparision: (avarage message length) ", autors_lenght)